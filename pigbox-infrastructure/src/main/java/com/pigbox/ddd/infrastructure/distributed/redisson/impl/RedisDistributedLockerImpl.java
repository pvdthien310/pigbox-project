package com.pigbox.ddd.infrastructure.distributed.redisson.impl;
...
public class RedisDistributedLockerImpl implements RedisDistributedService {
    ...
    @Override
    public RedisDistributedLocker getDistributedLock(String key) {
        ...
        return new RedisDistributedLocker() {
            ...
            public boolean tryLock(long waitTime, long leaseTime, TimeUnit unit) throws InterruptedException {
                ...
                log.info("{} get lock result: {}", key, isLockedSuccess);
